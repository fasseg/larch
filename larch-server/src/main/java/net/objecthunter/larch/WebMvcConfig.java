...
import net.objecthunter.larch.controller.oauth.AccessConfirmationController;
import net.objecthunter.larch.controller.oauth.AdminController;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public AdminController adminController(TokenStore tokenStore, ConsumerTokenServices tokenServices,
            LarchUserApprovalHandler userApprovalHandler) {
