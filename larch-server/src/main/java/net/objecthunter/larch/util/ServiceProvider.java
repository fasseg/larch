...
/**
 * A service provider for the various CraSH shell groovy commands. This is used since the {@link org.springframework.beans.factory.annotation.Autowired} annotation
 * does not seem to work to inject services in the groovy scripts
 */
