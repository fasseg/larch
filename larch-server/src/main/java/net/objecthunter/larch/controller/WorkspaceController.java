...
public class WorkspaceController extends AbstractLarchController {
    ...
    public void create(final Workspace workspace) throws IOException {
        this.entityService.createWorkspace(workspace);
    }
    ...
    @ResponseStatus(HttpStatus.OK)
    public void update(@PathVariable("id") final String id, final Workspace workspace) throws IOException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void patch(@PathVariable("id") final String id, final Workspace workspace) throws IOException {
        if (!id.equals(workspace.getId())) {
            throw new IOException("Workspace id does not match id given in the URL");
        }
