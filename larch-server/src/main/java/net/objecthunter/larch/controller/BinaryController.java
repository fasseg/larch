...
public class BinaryController {
    ...
    public String create(@AuthenticationPrincipal User user, @PathVariable("id") final String entityId, @RequestParam("name") final String name, @RequestParam("binary") final MultipartFile file) throws IOException {
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public void download(@AuthenticationPrincipal User user,@PathVariable("id") final String id, @PathVariable("binary-name") final String name, final HttpServletResponse response) throws IOException {
        // TODO: Content Size
