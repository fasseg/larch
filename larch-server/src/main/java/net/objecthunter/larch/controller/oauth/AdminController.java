...
package net.objecthunter.larch.controller.oauth;
...
import net.objecthunter.larch.LarchUserApprovalHandler;
...
public class AdminController {
    ...
    private LarchUserApprovalHandler userApprovalHandler;
    ...
    public ResponseEntity<Void>
            revokeToken(@PathVariable String user, @PathVariable String token, Principal principal)
                    throws Exception {
        checkResourceOwner(user, principal);
     ...
     */
    public void setUserApprovalHandler(LarchUserApprovalHandler userApprovalHandler) {
